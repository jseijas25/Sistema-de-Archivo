...
import controladores.ControladorVistaExpediente;

public class VistaExpedientes extends JDialog {

	private String ruta="../Sistema/imagenesSistema/";
	private Expediente xexpediente;
	private JPanel panelPrincipal,pestana1,panelcheck, panelCampos,panelBotonera,panelAuxiliar, paneltitulo, panelprograma;
	...
	public VistaExpedientes(Expediente xExpediente){
		...
		//imagenes
				...
				btnBuscar.setToolTipText("Buscar Expediente por cedula.");
		...
		//		btnImprimir.setEnabled(false);
				...
				//----------->enlaces<-----------
				ControladorVistaExpediente eco=new ControladorVistaExpediente(this,xexpediente);
